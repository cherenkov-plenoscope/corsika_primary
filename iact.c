...
# define MAX_IO_BUFFER 200000000000
#endif
...
void telrnh_ (cors_real_t runh[273])
{
   ...
   if ( iobuf == 0 )
   {
      ...
      /*iobuf->max_length = 6*1000*1000*1000;*/
   ...
   double *thetap, double *phip)
{
   ...
   /* This is how values would be assigned. Only non-sense assigned here. */
   *type = 0;
   *eprim = 0.;
   *thetap = 0.;
   *phip = 0.;

   /* This is just a placeholder and we better abort at this point */
   fprintf(stderr," This version of the EXTPRM function is only a placeholder and not functional.\n");
   fprintf(stderr," You need to implement your own user-defined function before making use of\n");
   fprintf(stderr," external setup of primary cosmic rays.\n");
